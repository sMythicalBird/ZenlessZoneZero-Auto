...
import numpy as np
import cv2
image_to_quan = cv2.imread("C:\\Users\\123\\Desktop\\juequling\\yuan.png", cv2.IMREAD_GRAYSCALE)
...
def turn():
    while (True):
        ...
        for i in range(10):
            ...
            min_val, max_val, min_loc, max_loc = cv2.minMaxLoc(result)  # max_val为识别图像左上角坐标
            if max_val > 0.85:
                flag = 1
                print("quan")
                x, _ = max_loc
